...
<img src="phani-transparent.svg" alt="Phani Harsha Daggu" width="100%" /> 
...
1️⃣ **Swimmer Performance Analysis** | 🔗[GitHub Repo](https://github.com/Daggu-phaniharsha/Swimmer-Performance-Analyzer)
   - 🌟  Developed a web-based tool to analyze swimmer lap times, visualize performance metrics, predict race outcomes using linear regression, and display personalized insights through a Flask UI.
   - 🛠 Tech used: Python, Flask, Pandas, Matplotlib, scikit-learn, and NumPy
